...
This package includes a set of Shiny apps for exploring single cell RNA sequencing (scRNA-seq) datasets processed as
...
using the 
<a href="https://bioconductor.org/packages/devel/bioc/vignettes/batchelor/inst/doc/correction.html" target="_blank" rel="noopener noreferrer">batchelor</a> package. Default settings rely on the `correctExperiments()` function to preserve pre-existing data and metadata from input objects in the corrected output.
